...
document.querySelector("#image-21").addEventListener("click", function(){
    document.querySelector("#image-21").style.visibility = "hidden";
})

document.querySelector("#image-22").addEventListener("click", function(){
    document.querySelector("#image-22").style.visibility = "hidden";
})

document.querySelector("#image-23").addEventListener("click", function(){
    document.querySelector("#image-23").style.visibility = "hidden";
})

document.querySelector("#image-24").addEventListener("click", function(){
    document.querySelector("#image-24").style.visibility = "hidden";
})

document.querySelector("#image-25").addEventListener("click", function(){
    document.querySelector("#image-25").style.visibility = "hidden";
})
...
document.querySelector("#image-27").addEventListener("click", function(){
    document.querySelector("#image-27").style.visibility = "hidden";
})